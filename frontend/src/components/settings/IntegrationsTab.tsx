...
import { LeadIntegrations, AnalyticsIntegrations, Integration, CategoryItem } from './integrations/modules';
...
const IntegrationsTab: React.FC = () => {
  ...
  const categories: CategoryItem[] = [
    ...
    { 
      ...
      count: integrations.filter(i => !['elementor', 'contact-form-7'].includes(i.type)).length 
    }
  ];
