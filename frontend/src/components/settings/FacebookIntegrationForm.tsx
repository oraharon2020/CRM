...
const FacebookIntegrationForm: React.FC<FacebookIntegrationFormProps> = ({
  initialData,
  onSave,
  onCancel
}) => {
      ...
      <div className="bg-blue-50 p-4 border-b border-blue-100">
        <div className="flex items-center">
          <div className="h-10 w-10 rounded-full bg-blue-100 flex items-center justify-center mr-3">
            <HiSpeakerphone className="h-6 w-6 text-blue-600" />
          </div>
          <div>
            <h2 className="text-lg font-medium text-gray-900">
              {initialData ? 'ערוך חיבור פייסבוק' : 'חיבור חדש לפייסבוק'}
            </h2>
            <p className="text-sm text-gray-500">הגדר חיבור לקמפיינים בפייסבוק</p>
          </div>
        </div>
      </div>
        ...
        <div className="space-y-6">
          <div>
            ...
            <input
              ...
              placeholder="לדוגמה: קמפיין פייסבוק - קיץ 2023"
              required
            />
          </div>
          ...
          <div>
            ...
            <p className="text-xs text-gray-500 mb-3">
              הגדר כיצד שדות הטופס בפייסבוק ימופו לשדות הליד במערכת
            </p>
